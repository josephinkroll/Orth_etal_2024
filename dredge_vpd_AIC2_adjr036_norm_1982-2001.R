...
#   for(x in 1:180){
#     for(y in 1:90){
#       av_lai.array[x,y,i] <- mean(av_lai_yr.list[[i]][x,y,c(2:21)])
#     }
#   }
# }
# 
...
# save.image("/Net/Groups/BGI/people/jdenis/scripts/Data/dredge_vpd_LAI005_acccmip6_EF_yr_AIC005_1982_2001.RData")
save.image("/Net/Groups/BGI/people/jdenis/scripts/Data/dredge_AIC2_adjr036_norm_1982_2001.RData")
...
ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/dom_water_var_AIC2_adjr036_1982_2001.png", plot = b, width = 9*1.5, height = 7*1.5, units = "in")
# ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/dom_var_AIC2_adjr036_1982_2001.png", plot = a, width = 9*1.5, height = 7*1.5, units = "in")
ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/FigS7.png", plot = a, width = 9*1.5, height = 7*1.5, units = "in")
ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/dom_var_rank_cluster_AIC2_adjr036_1982_2001.png", plot = draft_plot, width = 9*1.5, height = 14*1.5, units = "in")
...
# ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/test_mean_dom_water_var_yr_filteryrLAI_1982_2001_AIC005.png", plot = ddraft_plot, width = 9, height = 14, units = "in")
# ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/mean_dom_var_rank_AIC2_adjr036_1982_2001.png", plot = gt, width = 9*1.5, height = 14*1.5, units = "in")

ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/mean_dom_var_AIC2_adjr036_1982_2001.png", plot = gt1, width = 9*1.5, height = 7*1.5, units = "in")

ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/mean_dom_var_cluster_rank_AIC2_adjr036_1982_2001.png", plot = ddraft_plot_cluster, width = 9*1.5, height = 14*1.5, units = "in")

##### Fig5 #####

a_cluster <- ggplot(mean_dom_var_ts.df, aes(x=lon,y=lat,fill=cuts_mean_dom_var_cluster)) +
  geom_tile() +
  geom_map(data = mymap, map = mymap, aes(x = long, y = lat, map_id = id),
           inherit.aes = F, fill = NA, color = "black", size = .1) +
  scale_fill_manual("Mean dominant variable",
...
a_bar_mean_dom_var_cluster <- ggplot(area_mean_dom_var_cluster, aes(x = var_fac, y = area, fill = var_fac)) +
  geom_bar(stat='identity',col = 'black', width = .5, position = "stack") +
...
a_bar_mean_dom_var_cluster

for_legend <- ggplot(mean_dom_var_ts.df, aes(x=lon,y=lat,fill=cuts_mean_dom_var_cluster)) +
  geom_tile() +
  geom_map(data = mymap, map = mymap, aes(x = long, y = lat, map_id = id),
           inherit.aes = F, fill = NA, color = "black", size = .1) +
  scale_fill_manual("Mean dominant variable",
...
a_legend <- cowplot::get_legend(for_legend)
...
c_bar_mean_rank <- ggplot(area_mean_rank, aes(x = rank, y = area, fill = rank)) +
  geom_bar(stat='identity',col = 'black', width = 1, position = "stack") +
...
save(
  ...
  file = "/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/Fig5ac.RData"
)

##### FigS6 #####
aa <- ggplot(mean_dom_var_ts.df, aes(x=lon,y=lat,fill=cuts_mean_dom_var)) +
  geom_tile() +
  geom_map(data = mymap, map = mymap, aes(x = long, y = lat, map_id = id),
           inherit.aes = F, fill = NA, color = "black", size = .1) +
  scale_fill_manual("Mean dominant variable",
...
for_legend <- ggplot(mean_dom_var_ts.df, aes(x=lon,y=lat,fill=cuts_mean_dom_var)) +
  geom_tile() +
  geom_map(data = mymap, map = mymap, aes(x = long, y = lat, map_id = id),
           inherit.aes = F, fill = NA, color = "black", size = .1) +
  scale_fill_manual("Mean dominant variable",
...
a_bar_mean_dom_var <- ggplot(area_mean_dom_var, aes(x = var_fac, y = area, fill = var_fac)) +
  geom_bar(stat='identity',col = 'black', width = 1, position = "stack") +
...
save(
  ...
  file = "/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/FigS6.RData"
)
