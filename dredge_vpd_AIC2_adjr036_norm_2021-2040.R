...
# save.image("/Net/Groups/BGI/people/jdenis/scripts/Data/dredge_vpd_LAI005_acccmip6_EF_yr_AIC005_2021_2040.RData")
save.image("/Net/Groups/BGI/people/jdenis/scripts/Data/dredge_AIC2_adjr036_norm_2021_2040.RData")
...
ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/dom_water_var_AIC2_adjr036_2021_2040.png", plot = b, width = 9*1.5, height = 7*1.5, units = "in")
ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/dom_var_AIC2_adjr036_2021_2040.png", plot = a, width = 9*1.5, height = 7*1.5, units = "in")
ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/dom_var_rank_cluster_AIC2_adjr036_2021_2040.png", plot = draft_plot, width = 9*1.5, height = 14*1.5, units = "in")
...
# ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/test_mean_dom_water_var_yr_filteryrLAI_2021_2040_AIC005.png", plot = ddraft_plot, width = 9, height = 14, units = "in")
# ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/mean_dom_var_rank_AIC2_adjr036_2021_2040.png", plot = gt, width = 9*1.5, height = 14*1.5, units = "in")

ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/mean_dom_var_AIC2_adjr036_2021_2040.png", plot = gt1, width = 9*1.5, height = 7*1.5, units = "in")

ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/mean_dom_var_cluster_rank_AIC2_adjr036_2021_2040.png", plot = ddraft_plot_cluster, width = 9*1.5, height = 14*1.5, units = "in")
