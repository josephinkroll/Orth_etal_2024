...
#   for(x in 1:180){
#     for(y in 1:90){
#       av_lai.array[x,y,i] <- mean(av_lai_yr.list[[i]][x,y,c(22:41)])
#     }
#   }
# }
# 
...
for(h in 1:length(cmip6_data.df$source_id)){
  av_lai_yr.array[,,(ct_120:(ct_120+18))] <- av_lai_yr.array[,,(ct_120:(ct_120+18))] * mask_obs_yr[,,(ct_60:(ct_60+18))]
  av_mrsol_yr.array[,,(ct_120:(ct_120+18))] <- av_mrsol_yr.array[,,(ct_120:(ct_120+18))] * mask_obs_yr[,,(ct_60:(ct_60+18))]
  max_tasmax_yr.array[,,(ct_120:(ct_120+18))] <- max_tasmax_yr.array[,,(ct_120:(ct_120+18))] * mask_obs_yr[,,(ct_60:(ct_60+18))]
  min_mrsol_yr.array[,,(ct_120:(ct_120+18))] <- min_mrsol_yr.array[,,(ct_120:(ct_120+18))] * mask_obs_yr[,,(ct_60:(ct_60+18))]
  av_vpd_yr.array[,,(ct_120:(ct_120+18))] <- av_vpd_yr.array[,,(ct_120:(ct_120+18))] * mask_obs_yr[,,(ct_60:(ct_60+18))]
  av_pr_yr.array[,,(ct_120:(ct_120+18))] <- av_pr_yr.array[,,(ct_120:(ct_120+18))] * mask_obs_yr[,,(ct_60:(ct_60+18))]
  av_netrad_yr.array[,,(ct_120:(ct_120+18))] <- av_netrad_yr.array[,,(ct_120:(ct_120+18))] * mask_obs_yr[,,(ct_60:(ct_60+18))]
  av_rsds_yr.array[,,(ct_120:(ct_120+18))] <- av_rsds_yr.array[,,(ct_120:(ct_120+18))] * mask_obs_yr[,,(ct_60:(ct_60+18))]
  av_tas_yr.array[,,(ct_120:(ct_120+18))] <- av_tas_yr.array[,,(ct_120:(ct_120+18))] * mask_obs_yr[,,(ct_60:(ct_60+18))]
  ct_120 <- ct_120 + 120
  ct_60 <- ct_60 + 60
}
...
for(h in 1:length(cmip6_data.df$source_id)){
  for(x in 1:180){
    for(y in 1:90){
      if(sum(!is.na(av_lai_yr.array[x,y,(ct_120:(ct_120+18))])) == 19 & round(sd(av_lai_yr.array[x,y,(ct_120:(ct_120+18))]),4) != 0 & round(sd(av_mrsol_yr.array[x,y,(ct_120:(ct_120+18))]),4) != 0){
        relimp_variables.list <- list()
        rsq.vec <- c()
        # linear model with normalized predictors
        predictors.df <- data.frame("lai" = (av_lai_yr.array[x,y,(ct_120:(ct_120+18))] - min(av_lai_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T))/(max(av_lai_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T) - min(av_lai_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T)),
                                    "mrsol" = (av_mrsol_yr.array[x,y,(ct_120:(ct_120+18))] - min(av_mrsol_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T))/(max(av_mrsol_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T) - min(av_mrsol_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T)),
                                    "min_mrsol" = (min_mrsol_yr.array[x,y,(ct_120:(ct_120+18))] - min(min_mrsol_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T))/(max(min_mrsol_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T) - min(min_mrsol_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T)),
                                    "pr" = (av_pr_yr.array[x,y,(ct_120:(ct_120+18))] - min(av_pr_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T))/(max(av_pr_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T) - min(av_pr_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T)),
                                    "vpd" = (av_vpd_yr.array[x,y,(ct_120:(ct_120+18))] - min(av_vpd_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T))/(max(av_vpd_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T) - min(av_vpd_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T)),
                                    "tas" = (av_tas_yr.array[x,y,(ct_120:(ct_120+18))] - min(av_tas_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T))/(max(av_tas_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T) - min(av_tas_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T)),
                                    "max_tasmax" = (max_tasmax_yr.array[x,y,(ct_120:(ct_120+18))] - min(max_tasmax_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T))/(max(max_tasmax_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T) - min(max_tasmax_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T)),
                                    "rsds" = (av_rsds_yr.array[x,y,(ct_120:(ct_120+18))] - min(av_rsds_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T))/(max(av_rsds_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T) - min(av_rsds_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T)),
                                    "netrad" = (av_netrad_yr.array[x,y,(ct_120:(ct_120+18))] - min(av_netrad_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T))/(max(av_netrad_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T) - min(av_netrad_yr.array[x,y,(ct_120:(ct_120+18))], na.rm = T)))
...
# save.image("/Net/Groups/BGI/people/jdenis/scripts/Data/dredge_vpd_LAI005_acccmip6_EF_yr_AIC005_2002_2020.RData")
save.image("/Net/Groups/BGI/people/jdenis/scripts/Data/dredge_AIC2_adjr036_norm_2002_2020.RData")
...
ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/dom_water_var_AIC2_adjr036_2002_2020.png", plot = b, width = 9*1.5, height = 7*1.5, units = "in")
# ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/dom_var_AIC2_adjr036_2002_2020.png", plot = a, width = 9*1.5, height = 7*1.5, units = "in")
ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/FigS8.png", plot = a, width = 9*1.5, height = 7*1.5, units = "in")
ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/dom_var_rank_cluster_AIC2_adjr036_2002_2020.png", plot = draft_plot, width = 9*1.5, height = 14*1.5, units = "in")
...
# ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/test_mean_dom_water_var_yr_filteryrLAI_2002_2020_AIC005.png", plot = ddraft_plot, width = 9, height = 14, units = "in")
# ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/mean_dom_var_rank_AIC2_adjr036_2002_2020.png", plot = gt, width = 9*1.5, height = 14*1.5, units = "in")

ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/mean_dom_var_AIC2_adjr036_2002_2020.png", plot = gt1, width = 9*1.5, height = 7*1.5, units = "in")

ggsave("/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/mean_dom_var_cluster_rank_AIC2_adjr036_2002_2020.png", plot = ddraft_plot_cluster, width = 9*1.5, height = 14*1.5, units = "in")

##### Fig5 #####

b_cluster <- ggplot(mean_dom_var_ts.df, aes(x=lon,y=lat,fill=cuts_mean_dom_var_cluster)) +
  geom_tile() +
  geom_map(data = mymap, map = mymap, aes(x = long, y = lat, map_id = id),
           inherit.aes = F, fill = NA, color = "black", size = .1) +
  scale_fill_manual("Mean dominant variable",
...
b_bar_mean_dom_var_cluster <- ggplot(area_mean_dom_var_cluster, aes(x = var_fac, y = area, fill = var_fac)) +
  geom_bar(stat='identity',col = 'black', width = .5, position = "stack") +
  geom_text(inherit.aes = F, data = subset(area_mean_dom_var_cluster, area<1), aes(x=var,y=area+2.5,label=round(area,1)), size = 5) +
  geom_text(inherit.aes = F, data = subset(area_mean_dom_var_cluster, area>1), aes(x=var,y=area+2.5,label=round(area,0)), size = 5) +
  scale_x_discrete("") +
...
b_bar_mean_dom_var_cluster

dd <- ggplot(subset(mean_dom_water_var_ts.df, !is.na(mean_rank)), aes(x=lon,y=lat,fill=cuts_mean_rank)) +
  # cc <- ggplot(mean_dom_water_var_ts.df[which(!is.na(mean_dom_water_var_ts.df$mean_rank)),], aes(x=lon,y=lat,fill=cuts_mean_rank)) +
  geom_tile() +
  geom_map(data = mymap, map = mymap, aes(x = long, y = lat, map_id = id),
           inherit.aes = F, fill = NA, color = "black", size = .1) +
...
d_bar_mean_rank <- ggplot(area_mean_rank, aes(x = rank, y = area, fill = rank)) +
  geom_bar(stat='identity',col = 'black', width = 1, position = "stack") +
  geom_text(inherit.aes = F, data = subset(area_mean_rank, area<1), aes(x=rank,y=area+2.5,label=round(area,1)), size = 5) +
  geom_text(inherit.aes = F, data = subset(area_mean_rank, area>1), aes(x=rank,y=area+2.5,label=round(area,0)), size = 5) +
  scale_x_discrete("") +
  scale_y_continuous("", expand = c(0,0), limits = c(0, 30)) +
  scale_fill_manual(values = c("Rank1" = c(rev(brewer.pal(10, "RdYlBu")))[1:6][1],
                               "Rank2" = c(rev(brewer.pal(10, "RdYlBu")))[1:6][2],
...
save(
  ...
  file = "/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/Fig5bd.RData"
)
...
b_bar_mean_dom_var <- ggplot(area_mean_dom_var, aes(x = var_fac, y = area, fill = var_fac)) +
  geom_bar(stat='identity',col = 'black', width = 1, position = "stack") +
  geom_text(inherit.aes = F, data = subset(area_mean_dom_var, area<1), aes(x=var,y=area+2.5,label=round(area,1)), size = 3) +
  geom_text(inherit.aes = F, data = subset(area_mean_dom_var, area>1), aes(x=var,y=area+2.5,label=round(area,0)), size = 3) +
  scale_x_discrete("") +
  scale_y_continuous("", expand = c(0,0), limits = c(0, 30)) +
  # scale_y_continuous(expression(paste("land area-%")), expand = c(0,0), limits = c(0, (max(area_mean_dom_var$area)) + 5), position = "right") +
  scale_fill_manual(values = c("mrsol" = cols_mean_dom_var[1],
...
save(
  ...
  file = "/Net/Groups/BGI/people/jdenis/scripts/scripts_Nature_Perspective/FigS6b.RData"
)
